...
router.get("/api/admin/inquiries", auth_1.auth, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, mssql_1.exeQuery("SELECT * FROM ContactUs")];
            case 1:
                data = _a.sent();
...
router.delete("/api/admin/inquiries", auth_1.auth, function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var id, data, rowsAffected;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                id = req.body.id;
                return [4 /*yield*/, mssql_1.exeQuery("DELETE FROM ContactUs WHERE ID = " + id)];
            case 1:
                data = _a.sent();
