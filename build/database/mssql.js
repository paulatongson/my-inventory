...
exports.initializeTables = exports.exeQuery = void 0;
...
function initializeTables() {
    return __awaiter(this, void 0, void 0, function () {
        var initTableQuery, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    initTableQuery = fs_1.readFileSync("sql-init-command.sql", "utf-8");
                    _a.label = 1;
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, exeQuery(initTableQuery)];
                case 2:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 3:
                    error_1 = _a.sent();
                    console.log("LINE 19: ", error_1);
                    return [3 /*break*/, 4];
